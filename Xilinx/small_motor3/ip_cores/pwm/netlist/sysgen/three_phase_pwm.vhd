...
architecture structural of three_phase_pwm_struct is 
  ...
  signal enable_in_net : std_logic_vector( 1-1 downto 0 );
  ...
  signal mult2_p_net : std_logic_vector( 65-1 downto 0 );
  signal mult3_p_net : std_logic_vector( 65-1 downto 0 );
  signal register_q_net : std_logic_vector( 65-1 downto 0 );
  signal register1_q_net : std_logic_vector( 65-1 downto 0 );
  signal register2_q_net : std_logic_vector( 65-1 downto 0 );
begin
  ...
  mcode : entity xil_defaultlib.sysgen_mcode_block_42ff848af5 
  port map (
    clr => '0',
    x => relational_op_net,
  ...
  relational : entity xil_defaultlib.sysgen_relational_b5262e1d25 
  port map (
    clr => '0',
    a => counter_op_net,
    b => addsub1_s_net,
  ...
  relational1 : entity xil_defaultlib.sysgen_relational_3698c4d206 
  port map (
    clr => '0',
    a => counter_op_net,
    b => constant1_op_net,
  ...
  relational2 : entity xil_defaultlib.sysgen_relational_b23e631d65 
  port map (
    clr => '0',
    a => counter_op_net,
    b => register_q_net,
  ...
  relational3 : entity xil_defaultlib.sysgen_relational_b23e631d65 
  port map (
    clr => '0',
    a => counter_op_net,
    b => register1_q_net,
  ...
  relational4 : entity xil_defaultlib.sysgen_relational_b23e631d65 
  port map (
    clr => '0',
    a => counter_op_net,
    b => register2_q_net,
...
architecture structural of three_phase_pwm is 
  ...
  signal enable_in : std_logic_vector( 1-1 downto 0 );

...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set SimPeriod 1
	set SimTime 15000
	set SimulationTime {150210.00000000 ns}
	set SynthStrategyName {Vivado Synthesis Defaults}
	set SynthesisTool {Vivado}
	set TargetDir {/home/mikkeljaedicke/EMP/ip_cores/pwm/netlist}
	...
	dict set TopLevelPortInterface enable_out Name {enable_out}
	dict set TopLevelPortInterface enable_out Type Bool
	dict set TopLevelPortInterface enable_out ArithmeticType xlUnsigned
	dict set TopLevelPortInterface enable_out BinaryPoint 0
	dict set TopLevelPortInterface enable_out Width 1
	dict set TopLevelPortInterface enable_out DatFile {three_phase_pwm_enable_out.dat}
	dict set TopLevelPortInterface enable_out IconText {enable_out}
	dict set TopLevelPortInterface enable_out Direction out
	dict set TopLevelPortInterface enable_out Period 1
	dict set TopLevelPortInterface enable_out Interface 0
	dict set TopLevelPortInterface enable_out InterfaceName {}
	dict set TopLevelPortInterface enable_out InterfaceString {DATA}
	dict set TopLevelPortInterface enable_out ClockDomain {three_phase_pwm}
	dict set TopLevelPortInterface enable_out Locs {}
	dict set TopLevelPortInterface enable_out IOStandard {}
	...
	dict set TopLevelPortInterface timing_outpin DatFile {three_phase_pwm_timing_outpin.dat}
	...
	dict set TopLevelPortInterface timing_outpin ClockDomain {three_phase_pwm}
	...
	dict set MemoryMappedPort timing_in DatFile {three_phase_pwm_timing_in.dat}
	...
	dict set MemoryMappedPort timing_in ClockDomain {three_phase_pwm}
	...
	dict set MemoryMappedPort enable_in Name {enable_in}
	dict set MemoryMappedPort enable_in Type Bool
	dict set MemoryMappedPort enable_in ArithmeticType xlUnsigned
	dict set MemoryMappedPort enable_in BinaryPoint 0
	dict set MemoryMappedPort enable_in Width 1
	dict set MemoryMappedPort enable_in DatFile {three_phase_pwm_enable_in.dat}
	dict set MemoryMappedPort enable_in AddressOffset 8
	dict set MemoryMappedPort enable_in IconText {enable_in}
	dict set MemoryMappedPort enable_in Direction in
	dict set MemoryMappedPort enable_in Period 1
	dict set MemoryMappedPort enable_in Interface 2
	dict set MemoryMappedPort enable_in InterfaceName {}
	dict set MemoryMappedPort enable_in InterfaceString {CONTROL}
	dict set MemoryMappedPort enable_in ClockDomain {three_phase_pwm}
	dict set MemoryMappedPort enable_in Locs {}
	dict set MemoryMappedPort enable_in IOStandard {}
	...
	dict set MemoryMappedPort c_dutycycle_in AddressOffset 12
	...
	dict set MemoryMappedPort b_dutycycle_in AddressOffset 16
	...
	dict set MemoryMappedPort a_dutycycle_in AddressOffset 20
	...
	dict set MemoryMappedPort counter_out AddressOffset 24

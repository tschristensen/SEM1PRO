...
#define TASK4         		communication_task
#define TASK5         		adc_task
#define TASK6         		NULL
#define TASK7         		NULL
#define TASK8         		NULL
#define TASK9         		NULL
...
#define INIT_TASK4      	init_communication_task
#define INIT_TASK5      	init_adc_task

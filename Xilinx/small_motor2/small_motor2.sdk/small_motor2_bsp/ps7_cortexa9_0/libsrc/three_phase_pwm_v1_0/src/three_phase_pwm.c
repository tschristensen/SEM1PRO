...
void three_phase_pwm_b_dutycycle_in_write(three_phase_pwm *InstancePtr, u32 Data) {
    ...
    three_phase_pwm_WriteReg(InstancePtr->three_phase_pwm_BaseAddress, 16, Data);
}
...
void three_phase_pwm_a_dutycycle_in_write(three_phase_pwm *InstancePtr, u32 Data) {
    ...
    three_phase_pwm_WriteReg(InstancePtr->three_phase_pwm_BaseAddress, 20, Data);
}
u32 three_phase_pwm_a_dutycycle_in_read(three_phase_pwm *InstancePtr) {
    ...
    Data = three_phase_pwm_ReadReg(InstancePtr->three_phase_pwm_BaseAddress, 20);
    return Data;
}
u32 three_phase_pwm_counter_out_read(three_phase_pwm *InstancePtr) {
    ...
    Data = three_phase_pwm_ReadReg(InstancePtr->three_phase_pwm_BaseAddress, 24);
    return Data;
}

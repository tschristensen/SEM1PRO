...
#endif
/**
* Write to timing_in gateway of three_phase_pwm. Assignments are LSB-justified.
*
...
*
*/
void three_phase_pwm_timing_in_write(three_phase_pwm *InstancePtr, u32 Data);
/**
* Read from timing_in gateway of three_phase_pwm. Assignments are LSB-justified.
*
* @param	InstancePtr is the timing_in instance to operate on.
*
* @return	u32
...
*
*/
u32 three_phase_pwm_timing_in_read(three_phase_pwm *InstancePtr);
/**
...
/**
* Write to enable_in gateway of three_phase_pwm. Assignments are LSB-justified.
*
* @param	InstancePtr is the enable_in instance to operate on.
* @param	Data is value to be written to gateway enable_in.
*
* @return	None.
*
* @note    .
*
*/
void three_phase_pwm_enable_in_write(three_phase_pwm *InstancePtr, u32 Data);
/**
* Read from enable_in gateway of three_phase_pwm. Assignments are LSB-justified.
*
* @param	InstancePtr is the enable_in instance to operate on.
*
* @return	u32
...
*
*/
u32 three_phase_pwm_enable_in_read(three_phase_pwm *InstancePtr);
/**

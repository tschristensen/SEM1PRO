...
%		Author(s) Last name, First name, Company/Organisation, Year. Full Title
	...
	\bibitem{sevcon_gen4_manual}
		Tech/OPS Sevcon "Partner in Performance"  'Sevcon Gen4 Applications Reference Manual'
	\bibitem{battery_datasheet}
		Super B 'Super-B - SB12V20P-FC LiFepo4 battery.pdf - reference datasheet'.
	\bibitem{pwrElectronics}
		Mohan, Ned, John Wiley and Sons, 2012, Inc. Power Electronics A First Course
\end{thebibliography}
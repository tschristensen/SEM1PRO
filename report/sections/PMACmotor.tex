...
This gives a bit uneven armature resistances ranging from 5.2 to 6.9 $m\Omega$. This is about half the resistance listed by the manufacturer -- indicating, that they likely mean the resistance between two terminals is 13 $m\Omega$. However, since the motor is a Wye connection, it makes much more sense to know the resistance between a terminal and the star-point when modeling the motor 

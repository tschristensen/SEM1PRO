...
\end{figure}
As it can be seen it was chosen to build the inverter on a large heatsink, where also the Zybo, digital and analog boards are mounted for mechanical integrity. 

...
\begin{figure}[!h]
	...
	\caption[Task diagram.]{Task diagram of the complete system on the Zybo. Inside ARM rectangle circles are separate tasks while boxes are shared variables. In the PL all the FPGA components are shown. Outside the rectangle all the signals to and from the outside world are shown. SHOULD BE REWRITTEN!!!}
...
\end{lstlisting}
\todo[inline]{Thomas: Perhaps not quite as clever..}

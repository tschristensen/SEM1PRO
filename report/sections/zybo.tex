...
\end{figure}
\todo[inline]{Thomas: Task diagram: LEDs,Vsq\_ref+Vsd\_ref stretch to fit entire word on one line. Also, the TX/RX buffers should be labeled to match the text}

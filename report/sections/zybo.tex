...
\todo[inline]{Thomas: What sections are these? I don't remember reading about this.}
As described in the previous sections the Zybo board is required to handle a wide range of tasks.
This section will describe the different functionalities that has to be implemented.
...
\todo[inline]{Thomas: This is true, but it almost seems misplaced or is at least begging for elaboration. Are we taking steps to test/verify run times? Perhaps some testing would merit this discussion.}
...
Where $f_{zybo}$ is the clock frequency of the Zynq-7010. 
...
\todo[inline]{Thomas: explanation as to why it is important to only switch the switching limit while the counter is low}
...
\begin{figure}[!h]
	\centering
		\includegraphics[width=0.8\linewidth,trim=3cm 15cm 0 2cm]{graphics/controller_tasktikz}
...
\begin{figure}[!h]
	\centering
		\includegraphics[width=0.8\linewidth,trim=3cm 17cm 0 3cm]{graphics/pwm_tasktikz}

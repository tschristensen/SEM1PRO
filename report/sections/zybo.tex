...
\begin{figure}[!h]
	\centering
	\includestandalone[width=0.4\textwidth]{graphics/interface_flow}
...
Then the task will read all signals from the the digital boards and if they are all good the global enable variable will be changed to high.
...
The physical RMB28MD encoder signals are interfaceb by a IP Core made by the supervisors.

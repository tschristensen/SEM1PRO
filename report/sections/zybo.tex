...
\begin{figure}[!h]
	...
	\includegraphics[width=0.5\textwidth]{graphics/interface_flow}
...
With a resistor of 1\si{\kilo\ohm}, yields a capacitor of 56\si{\pico\farad}.
A capacitor of 33\si{\pico\farad} was chosen 


 of a capacitor is utilized to make a delay on the Slave Select signal, by putting a XX capacitor and XX resistor in series with the signal.

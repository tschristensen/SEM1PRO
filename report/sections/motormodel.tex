...
These equations yield the following controller values when inserting the known motor parameters, equation \ref{eq:Kpvalue} and \ref{eq:Kivalue}.
\begin{equation}
K_p=0.0111
\label{eq:Kpvalue}
\end{equation}
...
\label{eq:Kivalue}
\end{equation}
\todo[inline]{Martin: at which settling time? For simulations, I'm using 0.01 s.}

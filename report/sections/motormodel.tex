...
\begin{figure}[H]
	\centering
	\includegraphics[width=.75\linewidth]{graphics/State_space_reduced_order_v2}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.55\linewidth]{graphics/PZmap_ReducedOrder_V2}
...
\begin{figure}[H]
	...
	\caption{Fulld order vs reduced order model version 2}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.55\linewidth]{graphics/PZmap_ControlFullOrder}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.95\linewidth]{graphics/IPcontroller}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.55\linewidth]{graphics/PZmap_ControlReducedOrder}

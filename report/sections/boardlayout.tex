...
Since the maximum allowed current through the IRFP4468PBF (the MOSFET chosen for the inverter, see section \ref{sec:mosfet}) is 300\si{\ampere} and its $R_{ds(on)=3.2}$\si{\milli\ampere} the 
OC\_ADJ\_SET allows setting the value of $V_{ds}$ appropriate for the type of MOSFET chosen.

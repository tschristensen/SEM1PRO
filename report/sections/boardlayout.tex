...
Since there is some communication between the analog and the digital parts however, it is necessary to allow for some crossover.
...
\begin{figure}
	\centering
	\includegraphics[width=\linewidth]{graphics/driveenable}
\end{figure}

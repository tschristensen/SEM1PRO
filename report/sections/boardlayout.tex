...
$R_1$ and PEDAL form a variable voltage divider of the $15$\si{\volt} rail.
...
By isolating PEDAL, it's possible to calculate what its resistance is. 
The resistance of PEDAL varies from 0 to 7.5\si{\kilo\ohm}, as the pedal is pressed down. 
...
The DRV8301 is equipped with a buck converter capable of 
Initially it was the intention to use the buck converter in the driver chip to create the 5\si{\volt} rail needed to supply the Zybo board, however, for grounding reasons, it was decided to use the TVN5-4811WI, as mentioned previously.

...
Along with the inverse Clarke-park transformation, this block also injects the third harmonic sinusoidal. 
...
In order to verify the functionality of the OCP circuit discussed in section \ref{sec:ocpcircuit}, simulations were conducted in LTSpice\footnote{LTSpice: free simulation software created by Linear Technologies.}.

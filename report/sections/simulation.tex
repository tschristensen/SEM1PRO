...
Figure~\ref{fig:Sim_results_ip_Idq} shows 
...
\todo[inline]{Martin: Maybe a paragraph to seperate the controller simulations}
...
\todo[inline]{Martin: Need a non-slipping test here}

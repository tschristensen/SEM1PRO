...
In section \ref{sec:controller_design} an IP controller based on a reduced order model without any mechanical part is discussed.
Based on this controller analysis, it can be concluded that this reduction is not acceptable as this would result in an unstable system.
...
\end{eqnarray}
The battery wire is a 150\si{\mm\squared} wire, at five meters long including the connection to all the batteries. 
The 200 \si{\micro \ohm} is the resistance of the relay.
12.5 \si{\nano \henry \per \centi \meter} is a reasonable estimate of the inductance of a wire\footnote{According to a lecturer of the group, Morten Nymand}.\\

...
where $C_{p}$ is the specific heat capacity of aliminium, which is 910 \si{\joule\per\kilogram\kelvin}\todo{Reference in footnote: %http://www.engineeringtoolbox.com/specific-heat-metals-d_152.html}, 
and $\mathrm{\rho_m}$ is the mass density of aluminium.%\todo{Reference in footnote: http://www.coolmagnetman.com/magconda.html}. 

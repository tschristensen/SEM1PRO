...
As the observant reader will notice there are no third harmonic on the graphs, this is because third harmonic injection were not included at the time of the test. 
...
To ensure that the power board was working correctly a test of it was performed. 
...
They only housed the bare minimum functionality of the original boards. 
That being scaling of output from LEM sensors and torque pedal, routing of signals to/from the DRV8301 and a CR circuit for delaying the SPI slave select signal. 
\todo[inline]{More Martin? - Mikkel}
The already tested embedded system on the Zybo was connected and prpgrammed to run the motor.  
The motor span and ensured that the power board was working correctly. 
Several exciting measurements on the powerboard comes into mind, but were not done because of time constraints.
\todo[inline]{Too emotional. I know. Can somebody fix - Mikkel.}

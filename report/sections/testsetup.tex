...
\subsection{Collected System Test}
\todo[inline]{Morten. This section is not very scientific, i don't know much of the tests that were done.}

A test of all the products must be performed to determine if it works as intended when combined.

Problems during assembly with ground planes

problem with overcurrent protection

New boards made with (hulprint??)

Working product for powering a small AC motor

Not enough time to test the product with the go-kart

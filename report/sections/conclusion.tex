...
The OCP was simulated in order to verify its functionality, however, except for the driver board, due to time constraints it was not possible to finish the boards in time for the deadline.
As mentioned, a driver board was made to house the DRV8301, the driver chip used in the project.
...
It was discretized in preparation for using it on the embedded system.
...
Throughout there was problems with delivery of components that forced altering the time plan.
It would have been preferable to spend more time verifying and testing the electronics and the inverter to see whether it complies with the requirements set for the project.
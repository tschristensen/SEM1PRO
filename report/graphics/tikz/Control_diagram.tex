...
\node [blockzybo,yshift=-10em,xshift=13.5em](Zybo){};
\node [xshift=-6.2em,yshift=-24em](){Zybo Board};
...
%% Driver block
\node [blocktall, right of=PWM](DRVR){Driver};


%% Three Phase Inverter
\node [blocktall, right of=DRVR,xshift=2em](TPI){Three Phase Inverter};
...
%% Current Calculation
\node [blocktall, below of=DRVR,yshift=-2em](Calc){Current Calculation};
...
\path[line](Encoder.south) -|++(0,-2) --++(-14.76,0) |-node[circle,fill,inner sep=2pt]{}node[xshift=-0.8em]{$\theta_i$} ++(0,4.8) -|  (PWM.south);
...
\path[line](ABC.150) --node[xshift=-0.7em,yshift=0.5em]{$I_d$}++(-7.5,0) |- ([yshift=-1em]ID.west);
\path[line](ABC.210) --node[yshift=0.5em]{$I_q$}++(-8,0) |- ([yshift=-1em]IQ.west);
